    ...
    <label className={clsx('flex items-center gap-3 cursor-pointer', className)}>
      <div className="relative inline-flex items-center">
        <input
          ...
          {...props}
        />
        <div className="w-11 h-6 bg-bg-panel border border-border rounded-full peer peer-checked:bg-primary-purple peer-checked:border-primary-purple transition-colors duration-200" />
